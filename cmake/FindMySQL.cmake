...
if(MYSQL_FOUND)
  ...
  add_library(Deps::MySQL UNKNOWN IMPORTED)
  set_target_properties(Deps::MySQL PROPERTIES
    IMPORTED_LOCATION "${MYSQL_LIBRARY}"
    INTERFACE_INCLUDE_DIRECTORIES "${MYSQL_INCLUDEDIR}"
  )

  add_library(Deps::MySQLCppConn UNKNOWN IMPORTED)
  set_target_properties(Deps::MySQLCppConn PROPERTIES
    IMPORTED_LOCATION "${MYSQL_CPPCONN_LIBRARY}"
    INTERFACE_INCLUDE_DIRECTORIES "${MYSQL_CPPCONN_INCLUDEDIR}"
    INTERFACE_LINK_LIBRARIES "Deps::MySQL"
  )
endif()
