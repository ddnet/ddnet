...
if(WEBSOCKETS_FOUND)
  ...
  if(WEBSOCKETS_BUNDLED AND NOT EXISTS "${WEBSOCKETS_INCLUDEDIR}/lws_config.h")
    message(WARNING "Bundled libwebsockets is missing lws_config.h, update the ddnet-libs submodule (see ddnet/ddnet#10291)")
  endif()
