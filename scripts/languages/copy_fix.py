...
def copy_fix(infile: str, *, delete_unused: bool, append_missing: bool, delete_empty: bool) -> str:  # noqa: C901
    ...
    local = twlang.localizes() if delete_unused or append_missing else []
    supported = []
