...
* **-DLIBNOTIFY=[ON|OFF]** <br>
Whether to enable libnotify support for linux client. Setting to ON requires the `libnotify-dev` library installed. Default value is OFF.
