...
public:
	CDemoEdit(const char *pNetVersion, CSnapshotDelta *pSnapshotDelta, CSnapshotDelta *pSnapshotDeltaSeven, IStorage *pStorage, const char *pDemo, const char *pDst, int StartTick, int EndTick);
	void Run() override;
