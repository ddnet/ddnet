...
protected:
	...
	virtual void Cmd_RenderProgressSpinner(const CCommandBuffer::SCommand_RenderProgressSpinner *pCommand) { dbg_assert_failed("Call of unsupported Cmd_RenderProgressSpinner"); }
