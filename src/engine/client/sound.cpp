...
int CSound::Init()
{
	...
	SDL_GetAudioStreamFormat(m_pDevice, &Format, &FormatOut);

	m_MixingRate = FormatOut.freq;
	m_MaxFrames = 1024 * 2; // TODO: is 1024 ok
#if defined(CONF_VIDEORECORDER)
	...
	SDL_ResumeAudioDevice(SDL_GetAudioStreamDevice(m_pDevice));
	return 0;
}
...
void CSound::Shutdown()
{
	...
	SDL_AudioDeviceID DeviceID = SDL_GetAudioStreamDevice(m_pDevice);
