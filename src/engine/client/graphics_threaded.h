...
public:
	...
	int QuadContainerAddQuads(int ContainerIndex, const CQuadItem *pArray, int Num) override;
	int QuadContainerAddQuads(int ContainerIndex, const CFreeformItem *pArray, int Num) override;
