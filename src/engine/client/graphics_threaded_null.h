...
public:
	...
	int QuadContainerAddQuads(int ContainerIndex, CQuadItem *pArray, int Num) override { return -1; };
	int QuadContainerAddQuads(int ContainerIndex, CFreeformItem *pArray, int Num) override { return -1; };
