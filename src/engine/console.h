...
public:
	...
	virtual void ExecuteLine(const char *pStr, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) = 0;
	virtual void ExecuteLineFlag(const char *pStr, int FlasgMask, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) = 0;
	virtual void ExecuteLineStroked(int Stroke, const char *pStr, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) = 0;
