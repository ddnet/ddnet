...
public:
	...
	public:
		...
		virtual const ICommandInfo *NextCommandInfo(int AccessLevel, int FlagMask) const = 0;
		virtual int GetAccessLevel() const = 0;
	};
	...
	virtual void Init() = 0;
	virtual const ICommandInfo *FirstCommandInfo(int AccessLevel, int Flagmask) const = 0;
