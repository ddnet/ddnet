...
public:
	...
	virtual void Register(const char *pName, const char *pParams, const char *pHelp, int Flags, const FCommandCallbackNew &FCallback) = 0;
	...
	virtual void Chain(const char *pName, const FChainCommandCallbackNew &FChainCallback) = 0;
