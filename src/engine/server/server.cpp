...
void CServerBan::InitServerBan(IConsole *pConsole, IStorage *pStorage, CServer* pServer)
{
	...
	Console()->Register("ban", "ClientId|Ip [Minutes(30 minutes default)] [Reason]", CFGFLAG_SERVER|CFGFLAG_STORE, ConBanExt, this, "Ban player with ip/client id for x minutes for any reason");
}
...
void CServer::RegisterCommands()
{
	...
	Console()->Register("kick", "ClientId [Reason]", CFGFLAG_SERVER, ConKick, this, "Kick player with specified id for any reason");
	Console()->Register("status", "", CFGFLAG_SERVER, ConStatus, this, "List players");
	Console()->Register("shutdown", "", CFGFLAG_SERVER, ConShutdown, this, "Shut down");
	Console()->Register("logout", "", CFGFLAG_SERVER, ConLogout, this, "Logout of rcon");

	Console()->Register("record", "[Filename]", CFGFLAG_SERVER|CFGFLAG_STORE, ConRecord, this, "Record to a file");
