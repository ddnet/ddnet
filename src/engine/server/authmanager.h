...
private:
	...
	bool m_ReservedSlotsInitialized = false;
	bool m_TeleOthersSlotsInitialized = false;
...
public:
	// pRoles is a comma-separated list of roles that can use reserved slots
	void SetReservedSlotsConfig(const char *pRoles);

	// pRoles is a comma-separated list of roles that are allowed to teleport others
	void SetTeleOthersConfig(const char *pRoles);
