...
MACRO_CONFIG_INT(ClCensorChat, cl_censor_chat, 1, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Toggles chat censoring (0 = Disabled, 1 = Use downloaded and local list, 2 = Use only local list)")
