...
MACRO_CONFIG_INT(RpEnable, rp_enable, 0, 0, 1, CFGFLAG_SERVER, "Enable reverse proxy mode")
MACRO_CONFIG_STR(RpSecret, rp_secret, 65, "", CFGFLAG_SERVER, "Reverse proxy secret")
