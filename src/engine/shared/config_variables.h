...
MACRO_CONFIG_STR(SvCommunityToken, sv_community_token, 128, "", CFGFLAG_SERVER, "Token to register this server to a particular community")
MACRO_CONFIG_STR(SvServerTypeOverride, sv_server_type_override, 16, "", CFGFLAG_SERVER, "Used to group servers under a different string than the game type (which this falls back to)")
MACRO_CONFIG_STR(SvFlag, sv_flag, 4, "", CFGFLAG_SERVER, "Country flag to group this community under")
