...
MACRO_CONFIG_STR(SvYubikeyToken, sv_yubikey_token, 13, "", CFGFLAG_SERVER, "RCON Yubikey Token (12 chars)")
MACRO_CONFIG_INT(SvUseYubikey, sv_use_yubikey, 1, 0, 0, CFGFLAG_SERVER, "Use Yubikey Login")
MACRO_CONFIG_STR(SvRconPassword, sv_rcon_password, 64, "", CFGFLAG_SERVER, "Remote console password (full access)")
MACRO_CONFIG_STR(SvRconModPassword, sv_rcon_mod_password, 64, "", CFGFLAG_SERVER, "Remote console password for moderators (limited access)")
MACRO_CONFIG_STR(SvRconHelperPassword, sv_rcon_helper_password, 64, "", CFGFLAG_SERVER, "Remote console password for helpers (limited access)")
