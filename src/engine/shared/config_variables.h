...
MACRO_CONFIG_INT(SvRconAutoAuth, sv_rcon_auto_auth, 0, 0, 1, CFGFLAG_SERVER, "Automatically authenticate connections from local network addresses to the remote console")
