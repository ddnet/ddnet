...
MACRO_CONFIG_INT(ClBackgroundR, cl_background_r, 1, 0, 256, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show background")
MACRO_CONFIG_INT(ClBackgroundG, cl_background_g, 1, 0, 256, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show background")
MACRO_CONFIG_INT(ClBackgroundB, cl_background_b, 1, 0, 256, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show background")
