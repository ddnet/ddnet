...
MACRO_CONFIG_COL(ClHookCollTipColor, cl_hook_coll_tip_color, 4281073536, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Specifies the color of the hookline tip")
