...
MACRO_CONFIG_INT(BrFilterCompatibleProtocols, br_filter_compatible_protocols, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Filter out servers that don't support a protocol this client can connect with")
...
MACRO_CONFIG_STR(SvRegister, sv_register, 64, "1", CFGFLAG_SERVER, "Register server with master server for public listing, can also accept a comma-separated list of protocols to register on, like 'ipv4,ipv6,tw0.6,tw0.7,ws'")
