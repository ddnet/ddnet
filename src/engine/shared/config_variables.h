...
MACRO_CONFIG_INT(SvSaveGamesDelay, sv_savegames_delay, 180, 0, 10000, CFGFLAG_SERVER, "Delay in seconds for loading a savegame")
MACRO_CONFIG_INT(SvSaveGamesPenalty, sv_savegames_penalty, 60, 0, 10000, CFGFLAG_SERVER, "Penalty in seconds for saving or swapping position")
MACRO_CONFIG_INT(SvSwapTimeout, sv_swap_timeout, 30, 0, 10000, CFGFLAG_SERVER, "Penalty in seconds for saving or swapping position")
