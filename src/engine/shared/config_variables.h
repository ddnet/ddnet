...
MACRO_CONFIG_INT(ClAntiPingPreInputs, cl_antiping_preinputs, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "use inputs ahead of time")
...
MACRO_CONFIG_INT(SvPreInputs, sv_preinputs, 0, 0, 1, CFGFLAG_SERVER, "Sends client inputs to other clients before current tick. Increases the bandwidth required for the server. LAN use only")
