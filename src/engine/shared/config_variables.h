...
MACRO_CONFIG_INT(SvUnkill, sv_unkill, 2, 0, 2, CFGFLAG_SERVER, "Enables /unkill (1 = only allows unkill of teams that died with kill protection)")
MACRO_CONFIG_INT(SvUnkillMinTime, sv_unkill_min_time, 30, 0, 10000, CFGFLAG_SERVER, "Minimal time in seconds required to use /unkill")
MACRO_CONFIG_INT(SvSaveSwapGamesDelay, sv_saveswapgames_delay, 30, 0, 10000, CFGFLAG_SERVER, "Delay in seconds for loading a savegame or unkill or before swapping")
MACRO_CONFIG_INT(SvSaveSwapGamesPenalty, sv_saveswapgames_penalty, 60, 0, 10000, CFGFLAG_SERVER, "Penalty in seconds for saving or unkilling or swapping position")
