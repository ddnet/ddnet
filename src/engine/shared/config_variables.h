...
MACRO_CONFIG_INT(ClAntiPingPreInputs, cl_antiping_preinputs, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Predict other players using preinputs for more accurate predictions")
...
MACRO_CONFIG_INT(SvPreInputs, sv_preinputs, 0, 0, 1, CFGFLAG_SERVER, "Sends client inputs to other clients before their correct tick. Increases the bandwidth required for the server")
