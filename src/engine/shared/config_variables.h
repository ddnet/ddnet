...
MACRO_CONFIG_INT(SvStrictSpectateMode, sv_strict_spectate_mode, 0, 0, 2, CFGFLAG_SERVER, "0=show health/armor to specs 1=only show selected player 2=never show health/armor to others")
