...
MACRO_CONFIG_STR(SvBotVersionNumbers, sv_bot_version_numbers, 128, "", CFGFLAG_SERVER, "Comma seperated list of known bot clients to be punished by (sv_bot_punishment)")
