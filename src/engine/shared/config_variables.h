...
MACRO_CONFIG_INT(SvDnsblBanDuration, sv_dnsbl_ban_duration, 60, 0, 31557600, CFGFLAG_SERVER, "Blacklisted addresses automatic ban duration in seconds (0 = permanent)")
