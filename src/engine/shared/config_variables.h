...
MACRO_CONFIG_INT(DbgRenderLayers, dbg_render_layers, 0, 0, 7, CFGFLAG_CLIENT, "Debug map layer rendering (0: off, 1: group clips, 2: automatic quad clips, 4: quad cluster clips; bitwise")
#ifdef CONF_DEBUG
