...
MACRO_CONFIG_INT(SvSaveScores, sv_save_scores, 1, 0, 1, CFGFLAG_SERVER, "Whether to save scores")
...
MACRO_CONFIG_INT(SvTutorialServer, sv_tutorial_server, 0, 0, 1, CFGFLAG_SERVER, "Set server to tutorial mode")
