...
MACRO_CONFIG_INT(SvHighBandwidth, sv_high_bandwidth, 0, 0, 1, CFGFLAG_SERVER, "Use high bandwidth mode by default. Doubles the bandwidth required for the server.")
...
MACRO_CONFIG_INT(ClHighBandwidth, cl_high_bandwidth, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Request snapshot updates at 50Hz instead of 25Hz from supported servers (uses roughly twice the bandwidth for smoother gameplay)")
