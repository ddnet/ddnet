...
enum
{
	...
	SERVER_FLAG_TEAMS1				=	0x100,		// B
	SERVER_FLAG_TEAMS2				=	0x200,		// C
	SERVER_FLAG_STRICTTEAMS			=	0x400,		// D
	SERVER_FLAG_CHEATS				=	0x1000,		// E
	SERVER_FLAG_PAUSE				=	0x2000,		// F
	SERVER_FLAG_ENDLESSSUPERHOOKING	=	0x4000,		// G
	SERVER_FLAG_TIMERCOMMANDS		=	0x10000,	// H
	SERVER_FLAG_CHEATTIME			=	0x20000,	// I
	SERVER_FLAG_PAUSETIME			=	0x40000,	// J
