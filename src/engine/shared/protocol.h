...
enum
{
	...
	SERVERINFO_MAX_CLIENTS = 512,
	MAX_CLIENTS = 512,
	VANILLA_MAX_CLIENTS = 16,
	DDRACE64_MAX_CLIENTS = 64,
	DDRACE128_MAX_CLIENTS = 128,
	DDRACE512_MAX_CLIENTS = 512,
	SERVER_MAX_CLIENTS = 512,
	LEGACY_MAX_CLIENTS = DDRACE128_MAX_CLIENTS, // highest current legacy max clients required for idmapping
	MAX_CHECKPOINTS = 25,
	MIN_TICK = 0,
	MAX_TICK = 0x6FFFFFFF,
...
enum
{
	...
	VERSION_DDNET_512_PLAYERS_AND_TEAMS = 20010,
	VERSION_DDNET_SIZEEXTENDEDSNAPSHOT = 20010,
};
