...
// UUID(TEEHISTORIAN_AUTH_INIT, "teehistorian-auth-init@ddnet.tw") // deprecated
// UUID(TEEHISTORIAN_AUTH_LOGIN, "teehistorian-auth-login@ddnet.tw") // deprecated
UUID(TEEHISTORIAN_AUTH_INIT_ROLE, "teehistorian-auth-init-role@ddnet.tw")
UUID(TEEHISTORIAN_AUTH_LOGIN_ROLE, "teehistorian-auth-login-role@ddnet.tw")
