...
class CConsole : public IConsole
{
	...
	public:
		...
		static constexpr unsigned MAX_VICTIMS = 2;
		char m_aaSpecialVictims[MAX_VICTIMS][16];
		std::optional<int> m_aVictimIds[MAX_VICTIMS];
		void ResetVictims();
		void SetVictim(unsigned Slot, int Victim);
		void SetVictim(unsigned Slot, const char *pVictim);
