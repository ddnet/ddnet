...
public:
	...
	void Register(const char *pName, const char *pParams, const char *pHelp, int Flags, const FCommandCallbackNew &FCallback) override;
	...
	void Chain(const char *pName, const FChainCommandCallbackNew &FChainCallback) override;
