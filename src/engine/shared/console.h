...
class CConsole : public IConsole
{
	...
	void ExecuteLineStroked(int Stroke, const char *pStr, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) override;
...
public:
	...
	void ExecuteLine(const char *pStr, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) override;
	void ExecuteLineFlag(const char *pStr, int FlagMask, int ClientId = -1, bool InterpretSemicolons = true, bool AllowDangerous = true) override;
