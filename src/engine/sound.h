...
public:
	...
	virtual CVoiceHandle PlayAt(int ChannelID, int SampleID, int Flags, float x, float y, float Volume = 1.0f) = 0;
	virtual CVoiceHandle Play(int ChannelID, int SampleID, int Flags, float Volume = 1.0f) = 0;
