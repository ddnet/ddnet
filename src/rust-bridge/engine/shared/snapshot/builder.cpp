...
void cxxbridge1$CSnapshotBuilder$Init(::CSnapshotBuilder &self, bool seven) noexcept;
...
void CSnapshotBuilder::Init(bool seven) noexcept {
  cxxbridge1$CSnapshotBuilder$Init(*this, seven);
}
...
extern "C" {
::CSnapshotBuilder *cxxbridge1$box$CSnapshotBuilder$alloc() noexcept;
void cxxbridge1$box$CSnapshotBuilder$dealloc(::CSnapshotBuilder *) noexcept;
void cxxbridge1$box$CSnapshotBuilder$drop(::rust::Box<::CSnapshotBuilder> *ptr) noexcept;
} // extern "C"

namespace rust {
inline namespace cxxbridge1 {
template <>
::CSnapshotBuilder *Box<::CSnapshotBuilder>::allocation::alloc() noexcept {
  return cxxbridge1$box$CSnapshotBuilder$alloc();
}
template <>
void Box<::CSnapshotBuilder>::allocation::dealloc(::CSnapshotBuilder *ptr) noexcept {
  cxxbridge1$box$CSnapshotBuilder$dealloc(ptr);
}
template <>
void Box<::CSnapshotBuilder>::drop() noexcept {
  cxxbridge1$box$CSnapshotBuilder$drop(this);
}
} // namespace cxxbridge1
} // namespace rust
