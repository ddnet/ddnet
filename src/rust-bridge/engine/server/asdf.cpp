...
struct CAsdfImpl final : public ::rust::Opaque {
  static ::rust::Box<::CAsdfImpl> New(::rust::Str connect_to) noexcept;
  bool IsBanned(::NETADDR const &address, ::rust::Slice<char > reason_buf) const noexcept;
  bool BansHaveChanged() noexcept;
  ~CAsdfImpl() = delete;
...
::CAsdfImpl *cxxbridge1$194$CAsdfImpl$New(::rust::Str connect_to) noexcept;

bool cxxbridge1$194$CAsdfImpl$IsBanned(::CAsdfImpl const &self, ::NETADDR const &address, ::rust::Slice<char > reason_buf) noexcept;

bool cxxbridge1$194$CAsdfImpl$BansHaveChanged(::CAsdfImpl &self) noexcept;
} // extern "C"
...
::rust::Box<::CAsdfImpl> CAsdfImpl::New(::rust::Str connect_to) noexcept {
  return ::rust::Box<::CAsdfImpl>::from_raw(cxxbridge1$194$CAsdfImpl$New(connect_to));
}

bool CAsdfImpl::IsBanned(::NETADDR const &address, ::rust::Slice<char > reason_buf) const noexcept {
  return cxxbridge1$194$CAsdfImpl$IsBanned(*this, address, reason_buf);
}

bool CAsdfImpl::BansHaveChanged() noexcept {
  return cxxbridge1$194$CAsdfImpl$BansHaveChanged(*this);
}
