...
CONSOLE_COMMAND("showothersteams", "?i['0'|'1']", CFGFLAG_CHAT, ConShowOthersTeam, this, "Whether to show players from other teams or not (including in spec), optional i = 0 for off else for on")
