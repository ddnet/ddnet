...
#undef REGISTER_QUICK_ACTION
	...
	enum
	{
		...
		TILE_FNG_SPIKE_RED = 25,
		TILE_FNG_SPIKE_BLUE,
		TILE_FNG_SCORE_RED,
		TILE_FNG_SCORE_BLUE,

		TILE_FNG_SPIKE_GREEN = 30,
		...
		TILE_FNG_SPIKE_RED_OLD = 9,
		TILE_FNG_SPIKE_BLUE_OLD,
		TILE_FNG_SCORE_RED_OLD,
		TILE_FNG_SCORE_BLUE_OLD,

		TILE_FNG_SPIKE_GREEN_OLD = 14,
		TILE_FNG_SPIKE_PURPLE_OLD,
	};
