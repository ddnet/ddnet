...
CEditorActionEnvelopeDelete::CEditorActionEnvelopeDelete(CEditor *pEditor, int EnvelopeIndex, std::vector<std::shared_ptr<IEditorEnvelopeReference>> &vpObjectReferences, std::shared_ptr<CEnvelope> &Envelope) :
	IEditorAction(pEditor), m_EnvelopeIndex(EnvelopeIndex), m_pEnv(Envelope), m_vpObjectReferences(vpObjectReferences)
{
