...
void CEditorActionEditGroupProp::Undo()
{
	...
	{
		int NewGroupIndex = m_pEditor->m_Map.MoveGroup(m_Current, m_Previous);
		m_pEditor->m_SelectedGroup = NewGroupIndex;
	}
	else
		Apply(m_Previous);
}
...
void CEditorActionEditGroupProp::Redo()
{
	...
	if(m_Prop == EGroupProp::PROP_ORDER)
	{
		int NewGroupIndex = m_pEditor->m_Map.MoveGroup(m_Previous, m_Current);
		m_pEditor->m_SelectedGroup = NewGroupIndex;
	}
	else
		Apply(m_Current);
