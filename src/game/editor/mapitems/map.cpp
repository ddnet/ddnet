...
void CEditorMap::MakeRedirectLayer(const std::shared_ptr<CLayer> &pLayer)
{
	m_pRedirectLayer = std::static_pointer_cast<CLayerRedirect>(pLayer);
	m_pRedirectLayer->m_pEditor = m_pEditor;
}
