...
public:
	...
	bool NewButton(CTouchControls::CUnitRect Rect = {0, 0, CTouchControls::BUTTON_SIZE_MINIMUM, CTouchControls::BUTTON_SIZE_MINIMUM}, CTouchControls::EButtonShape Shape = CTouchControls::EButtonShape::RECT);
	void ResolveIssues();
