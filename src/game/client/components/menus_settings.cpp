...
void CMenus::RenderSettings(CUIRect MainView)
{
	...
	else if(m_NeedRestartGeneral || m_NeedRestartSkins || m_NeedRestartGraphics || m_NeedRestartSound || m_NeedRestartDDNet || m_NeedRestartTexture)
...
void CMenus::RenderSettingsGameskin(CUIRect MainView)
{
	...
	UiDoListboxStart(&s_Listbox, &MainView, 160.0f, Localize("Gameskin"), "", s_aSkinList.size(), 2, OldSelected, s_ScrollValue);
