...
void CMenus::RenderGame(CUIRect MainView)
{
	...
	if(g_Config.m_ClTouchControls)
	{
		...
		if(GameClient()->m_TouchControls.IsEditingActive())
		{
			...
			{
				m_MenusIngameTouchControls.m_aCachedVisibilities[(int)CTouchControls::EButtonVisibility::DEMO_PLAYER] = (int)CMenusIngameTouchControls::EVisibilityType::EXCLUDE;
