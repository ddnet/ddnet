...
public:
	...
	static void EnvelopeEval(int TimeOffsetMillis, int Env, ColorRGBA &Result, size_t Channels, IMap *pMap, IClient *pClient = nullptr, CGameClient *pGameClient = nullptr);
	static void EnvelopeEval(int TimeOffsetMillis, int Env, ColorRGBA &Result, size_t Channels, CMapLayers *pUser);
