...
{
	Console()->Register("callvote", "Type Value [Reason]", CFGFLAG_CLIENT, ConCallvote, this, "Call vote");
	Console()->Register("yes|no", "r", CFGFLAG_CLIENT, ConVote, this, "Vote yes/no");
}
