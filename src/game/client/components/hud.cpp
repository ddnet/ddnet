...
void CHud::RenderCursor()
{
	...
	else if(!g_Config.m_ClHideSpecCursor && m_pClient->m_Snap.m_pCursorInfo && m_pClient->m_Snap.m_SpecInfo.m_Active && m_pClient->m_Snap.m_SpecInfo.m_SpectatorID != SPEC_FREEVIEW)
	{
		// render spec cursor
