...
void CProjectile::Tick()
{
	...
	CCharacter *pTargetChr = GameWorld()->IntersectCharacter(PrevPos, ColPos, (m_Freeze || m_TeleCFrom) ? 1.0f : 6.0f, ColPos, pOwnerChar, m_Owner);
...
CProjectileData CProjectile::GetData() const
{
	...
	Result.m_TeleCFrom = m_TeleCFrom;
	return Result;
}
