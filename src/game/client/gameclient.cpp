...
void CGameClient::OnConsoleInit()
{
	...
	Console()->Register("team", "TeamId", CFGFLAG_CLIENT, ConTeam, this, "Switch team");
	...
	Console()->Register("change_map", "[Reason]", CFGFLAG_SERVER, 0, 0, "Change map");
	Console()->Register("restart", "[Seconds(default instant)]", CFGFLAG_SERVER, 0, 0, "Restart in x seconds");
	Console()->Register("broadcast", "Message", CFGFLAG_SERVER, 0, 0, "Broadcast message");
	Console()->Register("say", "Message", CFGFLAG_SERVER, 0, 0, "Say in chat");
	Console()->Register("set_team", "ClientId TeamId [Delay]", CFGFLAG_SERVER, 0, 0, "Set team of player to team");
	Console()->Register("set_team_all", "TeamId", CFGFLAG_SERVER, 0, 0, "Set team of all players to team");
	Console()->Register("add_vote", "Vote Reason", CFGFLAG_SERVER, 0, 0, "Add a voting option");
	Console()->Register("remove_vote", "Vote", CFGFLAG_SERVER, 0, 0, "remove a voting option");
	Console()->Register("force_vote", "Type Value [Reason]", CFGFLAG_SERVER, 0, 0, "Force a voting option");
	Console()->Register("clear_votes", "", CFGFLAG_SERVER, 0, 0, "Clears the voting options");
	Console()->Register("vote", "yes|no", CFGFLAG_SERVER, 0, 0, "Force a vote to yes/no");
