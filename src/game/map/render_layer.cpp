...
void CRenderLayerTile::RenderTileBorder(const ColorRGBA &Color, const CRenderLayerParams &Params, CTileLayerVisuals *pTileLayerVisuals)
{
	...
	{
		Border.Draw(pTileLayerVisuals, Color, ScreenX0, ScreenY0, ScreenX1, ScreenY1);
	}
...
void CRenderLayerTile::CRenderTileLayerBorder::Draw(const CTileLayerVisuals *pVisual, const ColorRGBA &Color, float ScreenX0, float ScreenY0, float ScreenX1, float ScreenY1)
{
