...
CHAT_COMMAND("tp", "?s[player name | x pos.] ?s[y pos.]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConTele, this, "Depending on the number of supplied arguments, teleport yourself to; (0.) where you are spectating or aiming; (1.) the specified player name; (2.) the specified coordinates.")
...
CHAT_COMMAND("teleport", "?s[player name | x pos.] ?s[y pos.]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConTele, this, "Depending on the number of supplied arguments, teleport yourself to; (0.) where you are spectating or aiming; (1.) the specified player name; (2.) the specified coordinates.")
