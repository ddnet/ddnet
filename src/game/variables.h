...
MACRO_CONFIG_STR(ClSkinSkinsTwDownloadUrl, cl_skin_skinstw_download_url, 100, "https://api.skins.tw/api/resolve/skins/", CFGFLAG_CLIENT | CFGFLAG_SAVE, "URL used to download skins from skins.tw")
...
MACRO_CONFIG_INT(ClDownloadSkinsTwSkins, cl_download_skinstw_skins, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Allow to download skins from skins.tw database when not found at cl_skin_community_download_url")
