...
MACRO_CONFIG_INT(ClShowFreezeCountdown, cl_show_freeze_countdown, 1, 0, 2, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show a freeze countdown under frozen players. 1 = bar, 2 = stars")
