...
MACRO_CONFIG_STR(ClVanillaSkinsPrefix, cl_vanilla_skins_prefix, 100, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Replace the vanilla skins with the prefix (e.g. kitty, coala, santa)")
