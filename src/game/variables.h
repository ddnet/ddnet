...
MACRO_CONFIG_INT(SvOldGrenadeExplosion, sv_old_grenade_explosion, 0, 0, 1, CFGFLAG_SERVER|CFGFLAG_GAME, "Grenade can explode twice when it times out and collides with wall in same tick")
