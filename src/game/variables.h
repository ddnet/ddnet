...
MACRO_CONFIG_STR(ClDDNetUpdate3Server, cl_ddnet_update3_server, 100, "update3.ddnet.tw", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Server to use to update new ddnet versions")
