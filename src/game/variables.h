...
MACRO_CONFIG_INT(ClDummyJump, cl_dummy_jump, 0, 0, 2, CFGFLAG_CLIENT, "Whether dummy is jumping")
MACRO_CONFIG_INT(ClDummyFire, cl_dummy_fire, 0, 0, 1, CFGFLAG_CLIENT, "Whether dummy is firing")
MACRO_CONFIG_INT(ClDummyHook, cl_dummy_hook, 0, 0, 2, CFGFLAG_CLIENT, "Whether dummy is hooking")
