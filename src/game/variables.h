...
MACRO_CONFIG_INT(ClDownloadSkinsTwSkins, cl_download_skinstw_skins, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Allow to download skins from skins.tw database when not found at cl_skin_download_url")
