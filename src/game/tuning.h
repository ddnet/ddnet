...
MACRO_TUNING_PARAM(GroundControlAccel, ground_control_accel, 100.0f / static_cast<float>(SERVER_TICK_SPEED), "Acceleration speed on the ground")
...
MACRO_TUNING_PARAM(AirControlSpeed, air_control_speed, 250.0f / static_cast<float>(SERVER_TICK_SPEED), "Max speed the tee can get in the air")
