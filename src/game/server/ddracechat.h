...
CHAT_COMMAND("showothersteams", "?i['0'|'1']", CFGFLAG_CHAT | CFGFLAG_SERVER, ConShowOthersTeam, this, "Whether to show players from other teams including in spec or not, optional i = 0 for off else for on")
