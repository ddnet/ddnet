...
void CGameTeams::Tick()
{
	...
	for(int i = 0; i < NUM_JOINABLE_TEAMS; i++)
	{
...
{
	for(int Team = 0; Team < NUM_ALL_TEAMS; Team++)
	{
...
{
	for(int i = 1; i < NUM_JOINABLE_TEAMS; i++)
...
{
	return Team >= TEAM_FLOCK && Team < NUM_JOINABLE_TEAMS;
}
