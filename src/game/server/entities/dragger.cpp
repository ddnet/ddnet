...
void CDragger::Snap(int SnappingClient)
{
	...
	else
	{
		...
		if(SnappingClient != SERVER_DEMO_CLIENT &&
			(GameServer()->m_Players[SnappingClient]->GetTeam() == TEAM_SPECTATORS ||
				GameServer()->m_Players[SnappingClient]->IsPaused()) &&
			GameServer()->m_Players[SnappingClient]->m_SpectatorID != SPEC_FREEVIEW)
