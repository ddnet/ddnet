...
{
	if((Team() == TEAM_FLOCK || Teams()->TeamFlock(Team()) || Teams()->Count(Team()) == 1 || Teams()->GetTeamState(Team()) == ETeamState::OPEN || !Teams()->TeamLocked(Team()) || !Teams()->IsAllowLeaderCommands(m_pPlayer->GetCid(), Team())))
	{
