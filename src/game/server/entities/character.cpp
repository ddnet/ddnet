...
bool CCharacter::Spawn(CPlayer *pPlayer, vec2 Pos)
{
	...
	m_TuneZone = Collision()->IsTuneZoneTile(Collision()->GetMapIndex(Pos));
...
void CCharacter::HandleTuneLayer()
{
	...
	m_TuneZone = m_TuneZoneOverride == TUNEZONE_OVERRIDE_NONE ? Collision()->IsTuneZoneTile(CurrentIndex) : 0;
	...
	else
	{
		...
		m_Core.m_Tuning = m_TuneZone ? TuningList()[m_TuneZone] : *Tuning();
	}
