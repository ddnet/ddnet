...
void CGameContext::RegisterDDRaceCommands()
{
	...
	Console()->Register("set_switch", "i[switch] i['0'|'1'] ?i[seconds]", CFGFLAG_SERVER | CMDFLAG_TEST, ConSetSwitch, this, "Sets switch to on or off for optional seconds (default: forever)");
...
void CGameContext::RegisterChatCommands()
{
	...
	Console()->Register("setswitch", "i[switch] i['0'|'1'] ?i[seconds]", CFGFLAG_CHAT | CMDFLAG_PRACTICE, ConPracticeSetSwitch, this, "Sets switch to on or off for optional seconds (default: forever)");
