...
private:
	...
	static void ConPracticeFreeze(IConsole::IResult *pResult, void *pUserData);
	static void ConPracticeUnFreeze(IConsole::IResult *pResult, void *pUserData);
	static void ConUnSuper(IConsole::IResult *pResult, void *pUserData);
	static void ConSuper(IConsole::IResult *pResult, void *pUserData);
	void ModifyWeapons(IConsole::IResult *pResult, void *pUserData, int Weapon, bool Remove);
	void MoveCharacter(int ClientId, int X, int Y, bool Raw = false);
	static void ConPracticeGoLeft(IConsole::IResult *pResult, void *pUserData);
	static void ConPracticeGoRight(IConsole::IResult *pResult, void *pUserData);
	static void ConPracticeGoUp(IConsole::IResult *pResult, void *pUserData);
	static void ConPracticeGoDown(IConsole::IResult *pResult, void *pUserData);
