...
TEST(Hash, Sha256)
{
	...
	SHA256_CTX *pCtxt = sha256_create_init();
	Expect(sha256_finish_destroy(pCtxt), "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
	...
	pCtxt = sha256_create_init();
	sha256_update(pCtxt, "The ", 4);
	sha256_update(pCtxt, "quick ", 6);
	sha256_update(pCtxt, "brown ", 6);
	sha256_update(pCtxt, "fox ", 4);
	sha256_update(pCtxt, "jumps ", 6);
	sha256_update(pCtxt, "over ", 5);
	sha256_update(pCtxt, "the ", 4);
	sha256_update(pCtxt, "lazy ", 5);
	sha256_update(pCtxt, "dog.", 4);
	Expect(sha256_finish_destroy(pCtxt), "ef537f25c895bfa782526529a9b63d97aa631564d5d789c2b765448c8635fb6c");
}
...
TEST(Hash, Md5)
{
	...
	MD5_CTX *pCtxt = md5_create_init();
	Expect2(md5_finish_destroy(pCtxt), "d41d8cd98f00b204e9800998ecf8427e");

	char QUICK_BROWN_FOX[] = "The quick brown fox jumps over the lazy dog.";
	Expect2(md5(QUICK_BROWN_FOX, str_length(QUICK_BROWN_FOX)), "e4d909c290d0fb1ca068ffaddf22cbd0");

	pCtxt = md5_create_init();
	md5_update(pCtxt, "The ", 4);
	md5_update(pCtxt, "quick ", 6);
	md5_update(pCtxt, "brown ", 6);
	md5_update(pCtxt, "fox ", 4);
	md5_update(pCtxt, "jumps ", 6);
	md5_update(pCtxt, "over ", 5);
	md5_update(pCtxt, "the ", 4);
	md5_update(pCtxt, "lazy ", 5);
	md5_update(pCtxt, "dog.", 4);
	Expect2(md5_finish_destroy(pCtxt), "e4d909c290d0fb1ca068ffaddf22cbd0");
}
