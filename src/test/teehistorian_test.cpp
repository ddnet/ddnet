...
TEST_F(TeeHistorian, Auth)
{
	const unsigned char EXPECTED[] = {
		...
		'e', 'f', 'a', 'u', 'l', 't', '_', 'a',
		'd', 'm', 'i', 'n', 0x00,
		// EX uuid=c5e0f871-6619-3f9d-b3f8-2481bb832f78 data_len=18
		0x4a,
		0xc5, 0xe0, 0xf8, 0x71, 0x66, 0x19, 0x3f, 0x9d,
		0xb3, 0xf8, 0x24, 0x81, 0xbb, 0x83, 0x2f, 0x78,
		0x12,
		// (AUTH_LOGIN_ROLE) cid=1 role="moderator" auth_name="foobar"
		0x01, 'm', 'o', 'd', 'e', 'r', 'a', 't',
		'o', 'r', 0x00, 'f', 'o', 'o', 'b', 'a',
		'r', 0x00,
		// EX uuid=c5e0f871-6619-3f9d-b3f8-2481bb832f78 data_len=13
		0x4a,
		0xc5, 0xe0, 0xf8, 0x71, 0x66, 0x19, 0x3f, 0x9d,
		0xb3, 0xf8, 0x24, 0x81, 0xbb, 0x83, 0x2f, 0x78,
		0x0d,
