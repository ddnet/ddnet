...
struct Transactions : public Points // NOLINT(readability-identifier-naming)
{
};
...
static auto g_pSqliteConnV2 = CreateSqliteConnection(":memory:", true, 2);
#if defined(CONF_TEST_MYSQL)
...
static auto g_pMysqlConnV2 = CreateMysqlConnection(gMysqlConfigV2);
#endif
