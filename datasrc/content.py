...
image_speedup_slide = Image("speedup_slide", "editor/speed_slide.png")
...
container.images.Add(image_speedup_slide)
...
set_speedup_slide = SpriteSet("speedup_slide", image_speedup_slide, 1, 1)
...
container.spritesets.Add(set_speedup_slide)
...
container.sprites.Add(Sprite("speedup_slide", set_speedup_slide, 0,0,1,1))
