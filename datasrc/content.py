...
container.sprites.Add(Sprite("hud_freeze_bar_full_left", set_hud, 0,2,1,2))
container.sprites.Add(Sprite("hud_freeze_bar_full", set_hud, 1,2,1,2))
container.sprites.Add(Sprite("hud_freeze_bar_empty", set_hud, 2,2,1,2))
container.sprites.Add(Sprite("hud_freeze_bar_empty_right", set_hud, 3,2,1,2))
