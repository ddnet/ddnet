...
image_material_particles = Image("material_particles", "material_particles.png")
...
container.images.Add(image_material_particles)
...
set_material_particles = SpriteSet("material_particles", image_material_particles, 8, 8)
...
container.spritesets.Add(set_material_particles)
...
container.sprites.Add(Sprite("part_snowflake01", set_material_particles, 0,0,1,1))
container.sprites.Add(Sprite("part_snowflake02", set_material_particles, 1,0,1,1))
container.sprites.Add(Sprite("part_snowflake03", set_material_particles, 2,0,1,1))
container.sprites.Add(Sprite("part_snowflake04", set_material_particles, 3,0,1,1))
