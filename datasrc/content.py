...
set_guiicons = SpriteSet("guiicons", image_guiicons, 16, 2)
...
container.sprites.Add(Sprite("guibutton_off", set_guibuttons, 0,0,3,4))
container.sprites.Add(Sprite("guibutton_on", set_guibuttons, 3,0,3,4))
container.sprites.Add(Sprite("guibutton_hover", set_guibuttons, 6,0,3,4))
