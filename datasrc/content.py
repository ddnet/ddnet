...
container.sprites.Add(Sprite("pickup_armor_ninja", set_extras, 8,2,2,2))
# Head up displays
container.sprites.Add(Sprite("hud_airjump", set_extras, 0,0,2,2))
container.sprites.Add(Sprite("hud_airjump_empty", set_extras, 0,2,2,2))
...
# On player displays
container.sprites.Add(Sprite("opd_freeze_bar_full", set_extras, 2,0,4,1))
container.sprites.Add(Sprite("opd_freeze_bar_empty", set_extras, 2,1,4,1))
container.sprites.Add(Sprite("opd_ninja_bar_full", set_extras, 2,2,4,1))
container.sprites.Add(Sprite("opd_ninja_bar_empty", set_extras, 2,3,4,1))
container.sprites.Add(Sprite("opd_direction_arrow", set_extras, 14,0,2,2)) # Key press indicator
container.sprites.Add(Sprite("opd_hook_strong", set_extras, 10,0,2,2))
container.sprites.Add(Sprite("opd_hook_weak", set_extras, 12,0,2,2))
# Particles
