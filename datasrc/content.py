...
container.sprites.Add(Sprite("targetswitch_close", set_extras, 0, 2, 2, 2))
container.sprites.Add(Sprite("targetswitch_open", set_extras, 2, 2, 2, 2))
container.sprites.Add(Sprite("targetswitch_alternate_decal", set_extras, 4, 2, 2, 2))
