...
set_emoticons = SpriteSet("emoticons", image_emoticons, 5, 5)
...
container.sprites.Add(Sprite("help", set_emoticons, 4, 0, 1, 1))
container.sprites.Add(Sprite("wait", set_emoticons, 4, 1, 1, 1))
container.sprites.Add(Sprite("spec", set_emoticons, 4, 2, 1, 1))
container.sprites.Add(Sprite("ache", set_emoticons, 4, 3, 1, 1))
container.sprites.Add(Sprite("wifi", set_emoticons, 0, 4, 1, 1))
container.sprites.Add(Sprite("clip", set_emoticons, 1, 4, 1, 1))
container.sprites.Add(Sprite("yes", set_emoticons, 2, 4, 1, 1))
container.sprites.Add(Sprite("no", set_emoticons, 3, 4, 1, 1))
container.sprites.Add(Sprite("talk", set_emoticons, 4, 4, 1, 1))
